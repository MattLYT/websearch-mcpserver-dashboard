...
func (t *TavilySearchImpl) SearchRawWithTimeRange(query string, lookbackDays int) ([]core.SearchResult, error) {
...
func (t *TavilySearchImpl) MergeContent(query string, results []core.SearchResult) (string, error) {
